...
# 
	...
	.globl	main
main:
        # Put 65537 = 2^16 + 1 in $t0 using lui and ori
        lui     $t0, 1                  # Put a 1 in bit 17 of $t0
        ori     $t0, $t0, 1             # Put a 1 in bit 0 of $t0
	...
	# Print $t0
        ...
        # Put 65537 = 2^16 + 1 in $t0 using lui and addi
	lui	$t0, 1                  # Put 1 in bit 17 of $t0
        addi    $t0, $t0, 1             # Put 1 in bit 0 of $t0 
...
pr_int: 
        ...
        .data
newln:  .asciiz "\n"
first:  .asciiz "Using lui and ori, 65537 = "
secnd:  .asciiz "Using lui and addi, 65537 = "
