/*
Timing either the call to Parallel_matrix_vector_prod in main or the entire body of this function in the function   2   /   2   
Call MPI_Barrier before start of timing 0   /   1   
Call MPI_Wtime after MPI_Barrier and before start of code to be timed   1   /   1   
Call MPI_Wtime immediately after completion of code to be timed 1   /   1   
Take the difference in the two times    1   /   1   
Call MPI_Reduce to get the *maximum* elapsed time   0   /   2   Did not get maximum eleapsed time.
Table of times  2   /   2   
