/*
###Print_loc_array###           
Correctly copy loc_arr into a string    2   /   2
Print the string    1   /   1
            
###Print_array###           
Malloc and free of temp array on proc 0 1   /   1
Correct call to MPI_Gather  1   /   1
Print array from process 0  1   /   1
