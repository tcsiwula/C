/*
Correct number of iterations (log_2(p)) 1   /   1   
Correct determination of whether a process is active    1   /   1   
Correct calculation of partner process rank 1   /   1   
Correct identification of the sender/receiver   1   /   1   Note: Did not display sender/receiver
Correct printouts   0   /   2   Missing iteration number, partner.
