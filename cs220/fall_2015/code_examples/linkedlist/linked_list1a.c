 ...
 *        for one.
 *    5.  This program has  a serious bug . . .
 */
#include <stdio.h>
#include <stdlib.h>
 ...
 * Input arg:  val:  new value to be inserted
 * In/out arg: head_pp: pointer to pointer to head of list
 */
void Insert(struct list_node_s** head_pp, int val) {
