/*
**Correctness**       
Accepts input in correct order  5 / 5 
Uses merge operation as basis of set operations 5 / 5 
Implement each set as singly linked list sorted in increasing order 5 / 5 
(No) memory leaks 5 / 5 
(Does not) sort the lists 5 / 5 
Accepts set input in required format  5 / 5 
Prints output in required format  5 / 5 
(Does not) print nondebug output in the op functions  5 / 5 
Test 1  5 / 5 
Test 2  5 / 5 
Test 3  5 / 5 
Test 4  5 / 5 
###Total Correctness###   60  / 60
        
***Documentation***       
Explanation of purpose of program and each function 5 / 5 
Explanation of prog input and output  5 / 5 
Explanation of function args and return value 5 / 5 
Obscure constructs explained  5 / 5 
###Total Documentation###   20  / 20
        
***Source Format***       
Blank lines used so easy to read  5 / 5 
Capitilzation is consistent 5 / 5 
###Total Source Format###   10  / 10
        
Quality of solution   0  / 10 Repeated searching a list for the last node, while the list is being created. Consider passing in and returning a pointer to the tail (-5). Main function longer than 40 lines (-5).
